 ...
 */
public class ProcesoRS extends javax.swing.JInternalFrame {
...
void habilitarAcciones() {
    ...
    private void BtnIngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIngActionPerformed
        ...
        if (ProcesoRS.isNumeric(id_reservacion.getText())&&ProcesoRS.isNumeric(id_cliente.getText())) {
    ...
    private void BtnBusCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBusCActionPerformed
        if (ProcesoRS.isNumeric(id_cliente.getText())) {
    ...
    private void BtnBusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBusActionPerformed
        if (ProcesoRS.isNumeric(id_reservacion.getText())&&id_reservacion.getText().length()!=0) {
            ...
            try {
                ...
                Logger.getLogger(ProcesoRS.class.getName()).log(Level.SEVERE, null, ex);
            }
